              ...
              <div className="card p-6">
                ...
                <div className="space-y-2">
                  <p className="text-gray-600 dark:text-gray-400">
                    ...
                    <a href="mailto:volunteers@imho-uk.org" className="text-primary-600 dark:text-primary-400 hover:underline">
                      volunteers@imho-uk.org
                    </a>
                  </p>
                  <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    ...
                    <a href="mailto:media@imho-uk.org" className="text-primary-600 dark:text-primary-400 hover:underline">
                      media@imho-uk.org
                    </a>
                  </p>
                </div>
